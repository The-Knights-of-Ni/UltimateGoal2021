...
public class ContourRingDetector extends LinearOpMode {
    ...
    private static final String WEBCAM_NAME = "Webcam 2"; // insert webcam name from configuration if using webcam
