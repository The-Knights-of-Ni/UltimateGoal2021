...
public class RectDetector {
    ...
    private RectRingPipeline ftclibPipeline;

    //The constructor is overloaded to allow the use of webcam instead of the phone camera
    public RectDetector(HardwareMap hMap) {
        hardwareMap = hMap;
    }

    public RectDetector(HardwareMap hMap, String webcamName) {
        hardwareMap = hMap;
        isUsingWebcam = true;
    ...
    public void init() {
        ...
        camera.setPipeline(ftclibPipeline = new RectRingPipeline());
